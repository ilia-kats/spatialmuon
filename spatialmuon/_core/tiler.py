...
class Tiles:
    def __init__(
        ...
        raster_tiles, masks_tiles, self.centers, self.origins = masks.extract_tiles(raster, tile_dim=tile_dim)
        ...
        if False:
            ...
            self.masks.plot(fill_colors='red', outline_colors=None, ax=ax)
            plt.show()
            ##
